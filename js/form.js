	            ...
	            $.ajax({
	                ...
	                success: function(data){
	                    ...
	                    if (data.ret == false) {
							...
							$("#status").html("Your Registration code is "+data.regKey+". Keep it safe.</br> We have also sent it to the email id you provided. Use this key during the payment transaction");
							$("#registerTeamButton").hide();
							$(".g-recaptcha").hide();
							$("#completion").html("<button onclick=\"popup(\'ragnarokdota2\');\" class=\"tsbutton\">Pay Now</button><script src=\"\/\/www.townscript.com\/javascripts\/js\/eventiframecontainer.min.js\" type=\"text\/javascript\"><\/script>");
