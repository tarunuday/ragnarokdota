...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Ragnarok Dota 2 Championship is an online Dota 2 tournament for teams based in India with a Rs.35000 prize pool">
                ...
                <form class="pure-form" id="registerTeam">
                    <div class="pure-g">
                        <div class="pure-u-2-3 pure-u-md-1-1 pure-u-lg-2-3">
                            <fieldset>
                                <legend>
                                    <div class="pure-u-11-24"><input class="team t-name" name="teamname" type="text" placeholder="Team Name (complete with sponsors names, if any)" required></div>
                                    <div class="pure-u-1-4"><input class="team t-nick" name="teamnick" type="text" placeholder="Team Tag/Abbreviation" required></div>
                                    <div class="pure-u-11-24"><input class="team t-mail" name="teammail" type="email" placeholder="Email (required)" required></div>
                                    <div class="pure-u-11-24"><input class="team t-number" name="teamnumber" type="text" placeholder="Phone Number (required)" required></div>
                                </legend>
                                <legend>
                                <div class="pure-u-1 blank-up-1 blank-down-1">
                                    ...
                                    For eg.
                                        ...
                                        "http://steamcommunity.com/profiles/76561197960435530" should enter "76561197960435530" without the quotes.</br>
                                        Also, make sure your steam profile is public.
                                        </span>
                                </div>
                                </legend>
                                ...
                                <section class="p-one">
                                    ...
                                    <div class="pure-u-6-24"><input class="one p-id" type="text" name="p_id_1" placeholder="Steam ID" required></div>
                                    <div class="pure-u-6-24"><input class="one p-name" type="text" name="p_name_1" placeholder="Full Name" required></div>
                                    <div class="pure-u-5-24"><input class="one p-nick" type="text" name="p_nick_1" placeholder="In-game Nickname" required></div>
                                ...
                                <section class="p-two">
                                    ...
                                    <div class="pure-u-6-24"><input class="two p-id" type="text" name="p_id_2" placeholder="Steam ID" required></div>
                                    <div class="pure-u-6-24"><input class="two p-name" type="text" name="p_name_2" placeholder="Full Name" required></div>
                                    <div class="pure-u-5-24"><input class="two p-nick" type="text" name="p_nick_2" placeholder="In-game Nickname" required></div>
                                    <div class="pure-u-1-24 chk">
                                        </div>
                                </section>
                                <section class="p-thr">
                                    ...
                                    <div class="pure-u-6-24"><input class="thr p-id" type="text" name="p_id_3" placeholder="Steam ID" required></div>
                                    <div class="pure-u-6-24"><input class="thr p-name" type="text" name="p_name_3" placeholder="Full Name" required></div>
                                    <div class="pure-u-5-24"><input class="thr p-nick" type="text" name="p_nick_3" placeholder="In-game Nickname" required></div>
                                    <div class="pure-u-1-24 chk">
                                        </div>
                                </section>
                                <section class="p-fou">
                                    ...
                                    <div class="pure-u-6-24"><input class="fou p-id" type="text" name="p_id_4" placeholder="Steam ID" required></div>
                                    <div class="pure-u-6-24"><input class="fou p-name" type="text" name="p_name_4" placeholder="Full Name" required></div>
                                    <div class="pure-u-5-24"><input class="fou p-nick" type="text" name="p_nick_4" placeholder="In-game Nickname" required></div>
                                    <div class="pure-u-1-24 chk">
                                        </div>
                                </section>
                                <section class="p-fiv">
                                    ...
                                    <div class="pure-u-6-24"><input class="fiv p-id" type="text" name="p_id_5" placeholder="Steam ID" required></div>
                                    <div class="pure-u-6-24"><input class="fiv p-name" type="text" name="p_name_5" placeholder="Full Name" required></div>
                                    <div class="pure-u-5-24"><input class="fiv p-nick" type="text" name="p_nick_5" placeholder="In-game Nickname" required></div>
                                    <div class="pure-u-1-24 chk">
                                        </div>
                                </section>
                                <section class="p-six">
                    ...
                    <div class="pure-g blank-down">
                        <div class="pure-u-3-5 pure-g">
                            ...
                            <div class="pure-u-1 is-center" id="completion">
                            </div>
                        </div>
                    </div>
                </form>
